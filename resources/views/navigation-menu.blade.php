                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            @if(Auth::user()->rol === 'Administrador' || Auth::user()->rol === 'Alumno')<x-dropdown-link href="{{ route('evaluaciones.index') }}">{{ __('Evaluaciones') }}</x-dropdown-link>@endif
                            ...
                            @if(Auth::user()->rol === 'Administrador' || Auth::user()->rol === 'Coordinador')<x-dropdown-link href="{{ route('solicitudes.index') }}">{{ __('Solicitudes') }}</x-dropdown-link>@endif
                        </x-slot>
                    </x-dropdown>
                </div>
                <div class="hidden sm:flex sm:items-center sm:ms-6">
