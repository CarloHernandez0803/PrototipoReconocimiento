...
use App\Models\SenalamientoPrueba;
...
class PruebaController extends Controller
{
    ...
    {
        $senalamientos = SenalamientoPrueba::all(); //Extrae todos los lotes registrados
    ...
    {
        $senalamiento = SenalamientoPrueba::findOrFail($id); //Busca el lote por su id
