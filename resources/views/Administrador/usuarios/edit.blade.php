            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('usuarios.update', $usuario->id_usuario) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="apellido" class="block font-medium text-sm text-gray-700">{{ __('Apellido') }}</label>
                            <input type="text" name="apellido" id="apellido" class="form-input rounded-md shadow-sm mt-1 block w-full"
