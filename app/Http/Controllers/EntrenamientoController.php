...
use App\Models\SenalamientoEntrenamiento;
...
class EntrenamientoController extends Controller
{
    ...
    {
        $senalamientos = SenalamientoEntrenamiento::all(); //Extrae todos los lotes registrados
    ...
    public function store(Request $request)
    {
        ...
        /* Crear el lote */
        SenalamientoEntrenamiento::create([
    ...
    {
        $senalamiento = SenalamientoEntrenamiento::findOrFail($id); //Busca el lote por su id
